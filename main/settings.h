...
typedef struct {
    bool need_hint;
    bool sr_enable;
    bool presselectric_enable;
    bool mqtt_phone_enable;
    /*下面是控制机器翻译的按钮的状态*/
    bool tcp_machine_translate;
    bool button_machine_determine;
    bool button_machine_clear;
    /*下面是控制AI问答的按钮的状态*/
    bool tcp_AI_Q_A;
    bool tcp_AI_Q_A_Determine;
    bool tcp_AI_Q_A_Clear; 
    bool demo_gui;
